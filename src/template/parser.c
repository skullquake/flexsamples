...
{
       0,    85,    85,    86,    89,    89,    90,    91,    92,    93,
      93,   100,   103,   118,   135,   144,   148,   151,   152,   155,
     157,   161,   164,   166,   170,   171,   172,   173,   176,   180
};
#endif
...
{
  "$end", "error", "$undefined", "BARCODE", "DATE", "PAGENUM", "VALUE",
  "ACCT", "ADDRESS", "INFO", "'\\n'", "'\\t'", "$accept", "statements",
  "statement", "$@1", "$@2", "addressBlock", "dh", "h1", "bc", "ad", "h2",
  "pb", "tr", "td", "f1", "f2", YY_NULLPTR
};
#endif
...
{
      -2,    -5,     1,   -36,    13,    14,    18,    22,    23,    24,
      26,    12,    21,   -36,    -2,    28,    -1,    -2,     5,    27,
      32,   -36,    29,    30,    31,    33,   -36,    34,    36,    37,
     -36,    39,   -36,   -36,   -36,   -36,    -2,    40,   -36,    38,
      44,    46,    47,    35,   -36,    17,    -2,   -36,    48,    45,
      49,    51,    52,    53,     7,    54,   -36,    55,    61,    62,
      10,    63,    64,   -36,    50,    65,    50,   -36,    66,    67,
      60,   -36,    68,    69,    70,    71,   -36,    -2,   -36,    49,
      72,    78,    73,    74,    79,    80,   -36,    81,   -36,    77,
      82,    83,    84,   -36,    85,    86,    90,    91,   -36,   -36,
     -36,    87,    93,   -36
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,     0,     1,     2,     0,     0,     0,     0,     0,
       0,    14,     0,     0,     0,     0,     3,     0,     0,     0,
       7,     0,     8,    26,    27,    25,     0,     0,    11,     0,
       0,     0,     0,     0,     4,     0,     0,    10,     0,     0,
       0,     0,     0,     0,     0,     0,     6,     0,     0,     0,
       0,     0,     0,    16,    17,     0,     0,    13,     0,     0,
       0,    22,     0,     0,     0,     0,    18,     0,    12,    21,
       0,     0,     0,     0,     0,     0,     5,     0,    23,     0,
       0,     0,     0,    29,     0,     0,     0,     0,    19,    20,
      28,     0,     0,    15
};
...
{
      30,    32,     1,    29,     2,     2,    11,     3,     3,    33,
      63,    34,    12,    13,    35,    64,    72,    21,    22,    73,
      47,    23,    21,    22,    14,    24,    55,    25,    15,    76,
      56,    78,    16,    17,    27,    18,    20,    36,    37,    53,
      39,    40,    41,     0,    42,    43,    44,    49,    45,    46,
      50,    48,    51,    52,    57,    26,    58,     0,    64,     0,
      59,    86,    60,    61,    62,    68,    69,    70,    71,    74,
      75,    81,    79,    80,     0,    77,     0,    89,    90,    82,
      83,    84,    85,    87,    88,    91,    92,    93,    94,     0,
       0,    98,    99,    95,    96,    97,   100,   101,   102,   103
};

static const yytype_int8 yycheck[] =
{
      16,    17,     4,     4,     6,     6,    11,     9,     9,     4,
       3,     6,    11,     0,     9,     8,     6,     5,     6,     9,
      36,     9,     5,     6,    10,     4,     9,     6,    10,    64,
      46,    66,    10,    10,     6,    11,    10,    10,     6,     4,
      11,    11,    11,    -1,    11,    11,    10,     9,    11,    10,
       6,    11,     6,     6,     6,    14,    11,    -1,     8,    -1,
      11,    77,    11,    11,    11,    11,    11,     6,     6,     6,
       6,    11,     6,     6,    -1,    10,    -1,     4,     4,    11,
      11,    11,    11,    11,     6,     6,     6,     6,    11,    -1,
      -1,     6,     6,    11,    11,    11,     6,     6,    11,     6
};
...
{
       0,     4,     6,     9,    13,    14,    18,    22,    24,    25,
      26,    11,    11,     0,    10,    10,    10,    10,    11,    16,
      10,     5,     6,     9,     4,     6,    13,     6,    19,     4,
      14,    23,    14,     4,     6,     9,    10,     6,    27,    11,
      11,    11,    11,    11,    10,    11,    10,    14,    11,     9,
       6,     6,     6,     4,    15,     9,    14,     6,    11,    11,
      11,    11,    11,     3,     8,    17,    20,    21,    11,    11,
       6,     6,     6,     9,     6,     6,    21,    10,    21,     6,
       6,    11,    11,    11,    11,    11,    14,    11,     6,     4,
       4,     6,     6,     6,    11,    11,    11,    11,     6,     6,
       6,     6,    11,     6
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      14,    14,    17,    17,    18,    19,    20,    21,    21,    22,
      22,    23,    24,    24,    25,    25,    25,    25,    26,    27
};
...
{
       0,     2,     2,     3,     0,     8,     5,     3,     3,     0,
       4,     3,     2,     1,     3,    11,     1,     1,     2,    11,
      11,     5,     7,     9,     1,     3,     3,     3,    11,     7
};
...
#line 135 "parser.y" /* yacc.c:1646  */
    { sprintf(line, "dh\t%s\t%s", (yyvsp[-2].string), (yyvsp[0].string)); 
	   		pagesInStatement += 1;
...
#line 144 "parser.y" /* yacc.c:1646  */
    { 
	   			sprintf(line, "h1\t%s\t%s\t%s\t%s\t%s\t%s", (yyvsp[-10].string), (yyvsp[-8].string), (yyvsp[-6].string), (yyvsp[-4].string), (yyvsp[-2].string), (yyvsp[0].string)); save_line(line); }
#line 1383 "parser.c" /* yacc.c:1646  */
    break;

  case 16:
#line 148 "parser.y" /* yacc.c:1646  */
    { sprintf(line, "bc\t%s", (yyvsp[0].string)); save_line(line); }
#line 1389 "parser.c" /* yacc.c:1646  */
    break;

  case 17:
#line 151 "parser.y" /* yacc.c:1646  */
    { sprintf(line, "%s", (yyvsp[0].string)); }
#line 1395 "parser.c" /* yacc.c:1646  */
    break;

  case 18:
#line 152 "parser.y" /* yacc.c:1646  */
    { tmp = strdup(line); strcpy(line, (yyvsp[-1].string)); strcat(line, tmp); free(tmp); }
...
#line 155 "parser.y" /* yacc.c:1646  */
    { 
	   			sprintf(line, "h2\t%s\t%s\t%s\t%s\t%s\t%s", (yyvsp[-10].string), (yyvsp[-8].string), (yyvsp[-6].string), (yyvsp[-4].string), (yyvsp[-2].string), (yyvsp[0].string)); save_line(line); }
...
#line 161 "parser.y" /* yacc.c:1646  */
    { sprintf(line, "pb\t%s\t%s\t%s", (yyvsp[-4].string), (yyvsp[-2].string), (yyvsp[0].string)); save_line(line); }
...
#line 164 "parser.y" /* yacc.c:1646  */
    { 
	   			sprintf(line, "tr\t%s\t%s\t%s\t%s", (yyvsp[-6].string), (yyvsp[-4].string), (yyvsp[-2].string), (yyvsp[0].string)); save_line(line); }
...
#line 166 "parser.y" /* yacc.c:1646  */
    { 
	   			sprintf(line, "tr\t%s\t%s\t%s\t%s\t%s", (yyvsp[-8].string), (yyvsp[-6].string), (yyvsp[-4].string), (yyvsp[-2].string), (yyvsp[0].string)); save_line(line); }
#line 1435 "parser.c" /* yacc.c:1646  */
    break;

  case 24:
#line 170 "parser.y" /* yacc.c:1646  */
    { sprintf(line, "td\t%s", (yyvsp[0].string)); }
#line 1441 "parser.c" /* yacc.c:1646  */
    break;

  case 25:
#line 171 "parser.y" /* yacc.c:1646  */
    { sprintf(line, "%s\t%s", (yyvsp[-2].string), (yyvsp[0].string)); }
...
#line 176 "parser.y" /* yacc.c:1646  */
    { 
	   			sprintf(line, "f1\t%s\t%s\t%s\t%s\t%s\t%s", (yyvsp[-10].string), (yyvsp[-8].string), (yyvsp[-6].string), (yyvsp[-4].string), (yyvsp[-2].string), (yyvsp[0].string)); save_line(line); }
#line 1466 "parser.c" /* yacc.c:1646  */
    break;

  case 29:
#line 180 "parser.y" /* yacc.c:1646  */
    { sprintf(line, "f2\t%s\t%s\t%s\t%s", (yyvsp[-6].string), (yyvsp[-4].string), (yyvsp[-2].string), (yyvsp[0].string)); save_line(line); }
